...
def main(args):
    ...
    with open('complexities_cupa_b1.npy', 'wb') as f:
        np.save(f, all_complexities[positions_b1])
    with open('complexities_cupa_b2.npy', 'wb') as f:
        np.save(f, all_complexities[positions_b2])
    with open('complexities_cupa_c1.npy', 'wb') as f:
        np.save(f, all_complexities[positions_c1])
    with open('complexities_cupa_c2.npy', 'wb') as f:
        np.save(f, all_complexities[positions_c2])
