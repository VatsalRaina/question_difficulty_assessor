...
parser.add_argument('--complexity_models_dir', type=str, help='Specify path to directory containing all trained complexity models')
...
def main(args):
    ...
    for seed in seeds:
        model_path = args.complexity_models_dir + "seed" + str(seed) + "/electra_seed" + str(seed) + ".pt"
